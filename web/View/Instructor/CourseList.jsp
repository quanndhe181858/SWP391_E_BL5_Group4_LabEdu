<%-- Document : CourseList.jsp Created on : Dec 4, 2025, 10:39:47 PM Author : quan --%>
                    ...
                    <div class="mb-8">
                        <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                            <div>
                                ...
                                <p class="text-lg text-gray-600 mt-1">Manage your courses, content, and student
                                    enrollments</p>
                            </div>
                            <a href="course?action=create"
                                    ...
                                    <div class="mb-6">
                                        ...
                                        <div class="relative">
                                            <input
                                                ...
                                                type="text" placeholder="Search courses..." id="search" name="search"
                                                ...
                                                <div class="flex items-center justify-between p-2 bg-gray-50 rounded cursor-pointer hover:bg-gray-100"
                                                    ...
                                                    <label class="flex items-center cursor-pointer w-full">
                                                        <input type="radio" name="filterCategoryId" value="${parent.id}"
                                                            ${param.filterCategoryId !=null &&
                                                            param.filterCategoryId==parent.id ? 'checked' : '' }
                                                            class="w-4 h-4 text-blue-600 border-gray-300 focus:ring-blue-500"
                                                            onchange="submitFilter()">
                                                        <span
                                                            class="ml-2 text-sm font-medium text-gray-700">${parent.name}</span>
                                                    </label>

                                                    <svg id="icon-${parent.id}"
                                                    ...
                                                    <c:forEach var="child" items="${children}">
                                                        <c:if test="${child.parent_id == parent.id}">
                                                            <label
                                                                ...
                                                                <input type="radio" name="filterCategoryId"
                                                                    value="${child.id}" ${param.filterCategoryId !=null
                                                                    && param.filterCategoryId==child.id ? 'checked' : ''
                                                                    }
                                                                    class="w-4 h-4 text-blue-600 border-gray-300 focus:ring-blue-500"
                                                                    onchange="submitFilter()">
                                                                <span
                                                                    class="ml-2 text-sm text-gray-600">${child.name}</span>
                                                            </label>
                                                        </c:if>
                                                    </c:forEach>
                                                </div>
                                ...
                                <div class="bg-white rounded-lg shadow-sm">
                                    ...
                                    <div class="p-6 border-b border-gray-200">
                                        ...
                                        <div
                                            ...
                                            <div>
                                                <p class="text-sm text-gray-600">Showing ${startItem}-${endItem} of
                                                    ${totalCourses} courses</p>
                                            </div>
                                            <div class="flex items-center gap-3">
                                                ...
                                                <select name="sortBy"
                                                    ...
                                                    <option value="updated_desc" ${param.sortBy=='updated_desc' ||
                                                        param.sortBy==null ? 'selected' : '' }>Recently Updated</option>
                                                    <option value="title_asc" ${param.sortBy=='title_asc' ? 'selected'
                                                        : '' }>Course Name (A-Z)</option>
                                                    <option value="students_desc" ${param.sortBy=='students_desc'
                                                        ? 'selected' : '' }>Most Students</option>
                                                    ...
                                                    <c:forEach items="${courseList}" var="course">
                                                        <div
                                                            ...
                                                            <div class="flex flex-col md:flex-row gap-6">
                                                                <div
                                                                    class="w-full md:w-48 h-32 bg-gradient-to-br from-blue-400 to-blue-600 rounded-lg flex-shrink-0">
                                                                </div>
                                                                ...
                                                                <div class="flex-grow">
                                                                    <div class="flex items-start justify-between mb-2">
                                                                        <div>
                                                                            <div class="flex items-center gap-2 mb-2">
                                                                                <span
                                                                                    class="px-2 py-1 text-xs font-semibold text-blue-600 bg-blue-100 rounded">${course.category.name}</span>
                                                                                <span
                                                                                    class="px-2 py-1 text-xs font-semibold ${course.status == 'published' ? 'text-green-600 bg-green-100' : 'text-yellow-600 bg-yellow-100'} rounded">${course.status}</span>
                                                                            </div>
                                                                            <h3
                                                                    ...
                                                                    <div class="flex flex-wrap gap-2">
                                                                        <a href="course?action=edit&id=${course.id}"
                                                                        ...
                                                                        <a href="course?action=content&id=${course.id}"
                                                                        ...
                                                                        <a href="course?action=students&id=${course.id}"
                                                                            class="inline-flex items-center px-4 py-2 bg-white border border-gray-300 text-gray-700 text-sm font-medium rounded-lg hover:bg-gray-50 transition">
                                                                            <svg class="w-4 h-4 mr-1" fill="none"
                                                                                stroke="currentColor"
                                                                                viewBox="0 0 24 24">
